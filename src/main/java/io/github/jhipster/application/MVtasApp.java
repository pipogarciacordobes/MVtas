...
public class MVtasApp {

    private static final Logger log = LoggerFactory.getLogger(MVtasApp.class);

    private final Environment env;

    public MVtasApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MVtasApp.class);
